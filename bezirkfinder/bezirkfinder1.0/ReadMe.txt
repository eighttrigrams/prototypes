================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : bezirkfinder1.0 Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese bezirkfinder1.0-Anwendung erstellt. 
...
Ihre bezirkfinder1.0-Anwendung bilden.

bezirkfinder1.0.vcproj
...
res\bezirkfinder10.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei bezirkfinder1.0.rc eingebunden.

res\bezirkfinder10.rc2
...
bezirkfinder1.0Dlg.h, bezirkfinder1.0Dlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse Cbezirkfinder10Dlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in bezirkfinder1.0.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    bezirkfinder1.0.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
