...
namespace ConsoleApplication1
{
    class CGuru
    {
        ...
        public void graphEditView(){
            toggleOFF(port, midiNotes[12], 14); //graph edit
        }
        public void padEditView(){
            toggleOFF(port, midiNotes[12], 15); //pad edit
        }
        public void scenesView(){
            toggleOFF(port, midiNotes[12], 18); //scenes view
        }
        public void undoCommand(){
            toggleOFF(port, midiNotes[12], 51);//undo
        }
        public void commitCommand(){
            toggleOFF(port, midiNotes[12], 49); //commit
        }
        public void recordCommand(){
            toggleOFF(port, midiNotes[12], 57); //recrd
        }
